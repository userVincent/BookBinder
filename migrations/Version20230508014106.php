...
final class Version20230508014106 extends AbstractMigration
{
    ...
    {
        //column state is added because it exists on Jun 5
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE meetup (id INT AUTO_INCREMENT NOT NULL, person1_id INT NOT NULL, person2_id INT NOT NULL, library_id INT NOT NULL, date DATE NOT NULL, time TIME NOT NULL,state INT NOT NULL, INDEX IDX_9377E283EF5821B (person1_id), INDEX IDX_9377E282C402DF5 (person2_id), INDEX IDX_9377E28FE2541D7 (library_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
